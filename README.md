...
| `/pages/use-case-cross-border-payments` | UC3: Onchain FX and Cross-Border Payments |
| `/pages/use-case-private-trading` | UC4: Private Payments and Asset Exchange |
...
Drag and drop the entire folder into [Netlify Drop](https://app.netlify.com/drop).
